    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 p-6">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 shadow-sm">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 dark:text-white">Patient Login</h1>
            <p className="text-xs text-slate-500 dark:text-slate-400">MediPilot Patient Health Portal</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-xl transition-colors shadow-sm disabled:opacity-50 mt-2"
          >
        ...
        <div className="mt-6 text-center text-xs text-slate-500 dark:text-slate-400">
          ...
          <Link href="/patient/signup" className="text-emerald-600 dark:text-emerald-400 font-semibold hover:underline">
            Sign up here
          </Link>
        </div>
